...
class Sort {
  static int eventParticipantSorter(EventParticipant a, EventParticipant b) {
  ...
  static int teamParticipantSorter(TeamParticipant a, TeamParticipant b) {
    return eventSorter(a.event!, b.event!) * -1;
  }

  static int eventSorter(Event a, Event b) {
    return DateTime.parse(a.startDate!).compareTo(DateTime.parse(b.startDate!));
  }

  static int teamSorter(Team a, Team b) {
  ...
  static int rankingSorter(Ranking a, Ranking b) {
    if (a.rank! < b.rank!) {
      return -1;
  ...
  static int matchSorter(Match a, Match b) {
  ...
  static int awardParticipantSorter(AwardRecipient a, AwardRecipient b) {
