...
class EventPageState extends State<EventPage> with TickerProviderStateMixin, RouteAware {
              ...
              PopupMenuButton(
                ...
                itemBuilder: (BuildContext c) {
                  return [
                    ...
                    eventSettings != null && eventSettings.isFavorite ? PopupMenuItem(
              ...
              WidgetsBinding.instance.addPostFrameCallback((Duration timeStamp) {
                ...
                Future.delayed(animationDuration + delay, () {
                  Navigator.of(context).push(
                    FadeRouteBuilder(page: EventSettingsDialog(eventSettings))
