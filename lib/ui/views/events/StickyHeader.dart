          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                  ...
                  child: Text(DateFormat("EEE", TOALocalizations.of(context).locale.toString()).format(date).toUpperCase(), style: TextStyle(fontWeight: FontWeight.w500, color: Colors.grey, fontSize: 12), textAlign: TextAlign.center)
              ),
